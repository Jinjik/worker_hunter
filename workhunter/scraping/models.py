...
class Url(models.Model):
    ...
    site = models.ForeignKey(Site, on_delete=models.CASCADE, verbose_name='Сайт для поиска')
    url_address = models.CharField(max_length=250, unique=True, verbose_name='Адрес для поиска')

    def __str__(self):
        return f'Специальность {self.speciality} в г.{self.city} на сайте {self.site}'
